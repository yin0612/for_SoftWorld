...
const HUIKE_2025_STRUCTURE = [
    ...
    },
    {
        ...
        keywords: [
            ...
            "洗錢防制", "電子票證", "悠遊付", "一卡通", "台灣Pay", "LINE Pay", "純網銀"
        ]
    },
    {
        id: "folder_3",
...
const PRESS_RELEASES = [
    ...
    },
    {
        ...
        companyName: '大宇資訊',
        companyColor: '#4a7c59',
        title: '大宇資旗下合騏綠能重電業務 Q3 獲利大幅跳升，集團現金流充裕助推次世代遊戲研發',
        category: '財務報告',
        huikeFolder: 'folder_3',
        huikeKeyword: '大宇資訊',
        excerpt: '大宇資轉型綠能與高科技控股有成，旗下合騏重電在手訂單能見度直達 2027 年，穩健的現金流讓遊戲子公司得以無後顧之憂投入精品單機研發。',
        date: '2026-08-24',
        source: '工商時報',
        url: 'https://www.ctee.com.tw/search/%E5%A4%A7%E5%AE%87%E8%B3%87',
        synthetic: false
    },
    {
        companyId: 'softstar',
        companyName: '大宇資訊',
        companyColor: '#4a7c59',
        title: '《女鬼橋》研發團隊宣布啟動 Unreal Engine 5 跨平台冒險新作，打造次世代國產敘事神作',
        category: '技術創新',
        huikeFolder: 'folder_3',
        huikeKeyword: '大宇資訊',
        excerpt: '接續《女鬼橋二 釋魂恩》在 Steam 獲得極度好評，大宇資訊遊戲研發部全面導入 UE5 次世代管線，新專案將同時登陸 PC 與家用主機平台。',
        date: '2026-09-06',
        source: '數位時代',
        url: 'https://www.bnext.com.tw/search?q=%E5%A4%A7%E5%AE%87%E8%B3%87%E8%A8%8A',
        synthetic: false
    },
    {
        companyId: 'softstar',
        companyName: '大宇資訊',
        companyColor: '#4a7c59',
        title: '大宇資訊 2026 東京電玩展 TGS 宣布參展陣容，攜多款原創獨立單機遊戲搶攻日韓主機市場',
        category: '新品發布',
        huikeFolder: 'folder_3',
        huikeKeyword: '大宇資訊',
        excerpt: '大宇資訊公告將於 9 月下旬幕張展覽館登場的東京電玩展設立專屬展區，展出多款未公開懸疑冒險新作，現場提供 PS5 與 Switch 實機試玩。',
        date: '2026-09-12',
        source: '巴哈姆特',
        url: 'https://gnn.gamer.com.tw/search.php?kw=%E5%A4%A7%E5%AE%87%E8%B3%87%E8%A8%8A',
        synthetic: false
    },
    {
        companyId: 'softstar',
        companyName: '大宇資訊',
        companyColor: '#4a7c59',
        title: '光聚晶電聯合完成控股架構重整，旗下遊戲子公司啟動自主營運與全球數位發行網絡',
        category: '策略合作',
        huikeFolder: 'folder_3',
        huikeKeyword: '大宇資訊',
        excerpt: '為使事業體分工更具彈性，光聚晶電聯合將原遊戲研發與 IP 授權事業切割至新設百分之百持股子公司，專注於 Steam 及歐美主機數位發行。',
        date: '2026-07-31',
        source: '鉅亨網',
        url: 'https://news.cnyes.com/search?q=%E5%A4%A7%E5%AE%87%E8%B3%87%E8%A8%8A',
        synthetic: false
    },
    ...
    },
    {
        ...
        companyName: '橘子集團',
        companyColor: '#f4a261',
        title: '《新楓之谷》暑期大改版登頂雙平台暢銷榜，於台北高雄舉辦玩家嘉年華湧入萬人同樂',
        category: '社群活動',
        huikeFolder: 'folder_3',
        huikeKeyword: '遊戲橘子',
        excerpt: '台灣國民級網遊《新楓之谷》迎接二十週年暑期更新，推出全新六轉職業進化分支與夏日音樂祭線下盛會，吸引全台數萬名骨灰級玩家同歡。',
        date: '2026-08-16',
        source: '自由時報',
        url: 'https://news.ltn.com.tw/search?keyword=%E9%81%8A%E6%88%B2%E6%A9%95%E5%AD%90',
        synthetic: false
    },
    {
        companyId: 'gamania',
        companyName: '橘子集團',
        companyColor: '#f4a261',
        title: '長青手遊《天堂M》全新職業「魔劍士」震撼降臨，帶動橘子集團 8 月單月合併營收年增 22%',
        category: '財務報告',
        huikeFolder: 'folder_3',
        huikeKeyword: '遊戲橘子',
        excerpt: '受惠於旗艦手遊《天堂M》全新近戰職業改版上線與限定伺服器火爆開服，橘子集團 8 月合併營收突破 11.5 億元，創近年同期新高。',
        date: '2026-09-01',
        source: '工商時報',
        url: 'https://www.ctee.com.tw/search/%E9%81%8A%E6%88%B2%E6%A9%95%E5%AD%90',
        synthetic: false
    },
    {
        companyId: 'gamania',
        companyName: '橘子集團',
        companyColor: '#f4a261',
        title: '橘子支付擴大交通與智慧零售生態圈，串接全台大眾運輸與大學商圈，月活躍交易戶衝破 220 萬',
        category: '技術創新',
        huikeFolder: 'folder_2',
        huikeKeyword: '第三方支付',
        excerpt: '橘子集團旗下橘子支付加速開拓非遊戲日常小額支付場景，結合 beanfun! 生態圈點數互通機制，用戶次月留存率攀升至 82%。',
        date: '2026-07-27',
        source: '經濟日報',
        url: 'https://money.udn.com/search/result/1001/%E6%A9%95%E5%AD%90%E6%94%AF%E4%BB%98',
        synthetic: false
    },
    {
        companyId: 'gamania',
        companyName: '橘子集團',
        companyColor: '#f4a261',
        title: 'Gamania Group Expands Enterprise AI Footprint with Advanced Predictive Analytics for Game Operations',
        category: '產業趨勢',
        huikeFolder: 'folder_3',
        huikeKeyword: '遊戲橘子',
        excerpt: 'TechCrunch features Gamania\'s AI-driven liveOps pipeline Vyin AI, highlighting its real-time churn prediction and automated in-game event optimization.',
        date: '2026-09-13',
        source: 'TechCrunch',
        url: 'https://techcrunch.com/?s=Gamania',
        synthetic: false
    },
    ...
    },
    {
        ...
        companyName: '網銀國際',
        companyColor: '#48cae4',
        title: '休閒娛樂龍頭《星城Online》品牌煥新正式更名為《星城》，推全通路實體跨界泛娛樂行銷',
        category: '產業趨勢',
        huikeFolder: 'folder_3',
        huikeKeyword: '網銀國際',
        excerpt: '營運超過 18 年的台灣休閒手遊霸主啟用全新極簡 Logo，並宣布結合實體影城、主題餐廳與潮流服飾展開跨界生活圈行銷，打破線上線下界限。',
        date: '2026-07-08',
        source: '天下雜誌',
        url: 'https://www.cw.com.tw/search/doSearch.action?key=%E7%B6%B2%E9%8A%80%E5%9C%8B%E9%9A%9B',
        synthetic: false
    },
    {
        companyId: 'wanin',
        companyName: '網銀國際',
        companyColor: '#48cae4',
        title: '網銀旗下電競戰隊閃電狼 Flash Wolves 勇奪世界電競大賽亞軍，展現台灣職業電競深厚底蘊',
        category: '電競賽事',
        huikeFolder: 'folder_3',
        huikeKeyword: '網銀國際',
        excerpt: '網銀國際長期扶植的職業電競戰隊閃電狼於世界電競冠軍賽中一路過關斬將，在總決賽與韓國強權鏖戰五局奪得亞軍，受到全台玩家高度喝采。',
        date: '2026-08-17',
        source: '4Gamers',
    ...
    },
    {
        ...
        companyName: '網銀國際',
        companyColor: '#48cae4',
        title: '網銀國際「遊e卡」攜手全台威秀影城推會員跨界回饋方案，打造全台最大影音休閒紅利生態',
        category: '策略合作',
        huikeFolder: 'folder_3',
        huikeKeyword: '網銀國際',
        excerpt: '為擴大遊e卡點數流通場景，網銀國際串聯威秀影城 iShow 會員系統，玩家可用儲值紅利免費兌換電影票與爆米花套餐，創造全新跨界綜效。',
        date: '2026-08-29',
        source: '經濟日報',
        url: 'https://money.udn.com/search/result/1001/%E7%B6%B2%E9%8A%80%E5%9C%8B%E9%9A%9B',
        synthetic: false
    },
    {
        companyId: 'wanin',
    ...
    },
    {
        ...
        companyName: '網銀國際',
        companyColor: '#48cae4',
        title: '網銀國際資安研發中心導入次世代 AI 交易異常告誡系統，主動防護數百萬娛樂城玩家帳號安全',
        category: '技術創新',
        huikeFolder: 'folder_3',
        huikeKeyword: '網銀國際',
        excerpt: '網銀國際宣布投入數億元升級集團資安大腦，利用生成式圖神經網絡偵測不法洗錢與盜刷黑客攻擊，獲得數位發展部頒發數位信任特優標章。',
        date: '2026-09-14',
        source: '數位時代',
        url: 'https://www.bnext.com.tw/search?q=%E7%B6%B2%E9%8A%80%E5%9C%8B%E9%9A%9B',
        synthetic: false
    },
    ...
    },
    {
        ...
        companyName: '宇峻奧汀',
        companyColor: '#3a86ff',
        title: '宇峻奧汀首度公開採用虛幻引擎 5 (UE5) 開發之武俠 RPG 神祕新作實機畫面，畫質驚豔',
        category: '技術創新',
        huikeFolder: 'folder_3',
        huikeKeyword: '宇峻奧汀',
        excerpt: '宇峻於台北總部技術發表會釋出自研 UE5 次世代武俠單機專案實機錄像，展示照片級光影追蹤與實時物理破壞，預計 2027 年登陸 PC 與家用主機。',
        date: '2026-08-08',
        source: '數位時代',
        url: 'https://www.bnext.com.tw/search?q=%E5%AE%87%E5%B3%BB%E5%A5%A7%E6%B1%80',
        synthetic: false
    },
    {
        companyId: 'userjoy',
        companyName: '宇峻奧汀',
        companyColor: '#3a86ff',
        title: '宇峻奧汀公布 Q2 財報每股獲利創近五年新高，受惠自研 IP 海外授權權利金與端遊雙輪驅動',
        category: '財務報告',
        huikeFolder: 'folder_3',
        huikeKeyword: '宇峻奧汀',
        excerpt: '宇峻奧汀上半年合併稅後淨利達 2.38 億元，年增率超過 45%，主要歸功於《FFXIV》穩定月費金流與日本市場自研手遊分潤挹注。',
        date: '2026-08-23',
        source: '經濟日報',
        url: 'https://money.udn.com/search/result/1001/%E5%AE%87%E5%B3%BB',
        synthetic: false
    },
    {
        companyId: 'userjoy',
        companyName: '宇峻奧汀',
        companyColor: '#3a86ff',
        title: '休閒博弈經典《拉斯維加斯娛樂城》舉辦暑期環球嘉年華，單月活躍用戶與儲值流水續創新猷',
        category: '社群活動',
        huikeFolder: 'folder_3',
        huikeKeyword: '宇峻奧汀',
        excerpt: '宇峻旗艦休閒手遊《拉斯維加斯娛樂城》推出限定全球主題機台，並與多位知名實況主合作直播抽獎，成功帶動海外北美與東南亞營收增長。',
        date: '2026-09-03',
        source: '工商時報',
        url: 'https://www.ctee.com.tw/search/%E5%AE%87%E5%B3%BB',
        synthetic: false
    },
    {
        companyId: 'userjoy',
    ...
    },
    {
        ...
        companyName: '華義國際',
        companyColor: '#9d4edf',
        title: '華義子公司取得海外離岸 B2B 娛樂技術服務商執照，擴大技術外銷與國際軟體授權收益',
        category: '產業趨勢',
        huikeFolder: 'folder_3',
        huikeKeyword: '華義國際',
        excerpt: '華義國際旗下技術子公司成功考取國際認可之高標準軟體安全與隨機數生成器 (RNG) 認證，未來將承接歐洲與東南亞線上平台軟體客製化代工。',
        date: '2026-07-19',
        source: '鉅亨網',
        url: 'https://news.cnyes.com/search?q=%E8%8F%AF%E7%BE%A9%E5%9C%8B%E9%9A%9B',
        synthetic: false
    },
    {
        companyId: 'wayi',
        companyName: '華義國際',
        companyColor: '#9d4edf',
        title: '華義旗下「遊戲大亂鬥」社群全面改版，新增短影音與電競即時賽況板塊，青年玩家月活躍破百萬',
        category: '社群活動',
        huikeFolder: 'folder_3',
        huikeKeyword: '華義國際',
        excerpt: '為迎合 Z 世代年輕玩家習慣，華義旗下知名玩家論壇「遊戲大亂鬥」全面升級社群架構，吸引眾多 KOL 實況主入駐建立個人專屬影音專區。',
        date: '2026-08-05',
        source: '4Gamers',
        url: 'https://www.4gamers.com.tw/site/search?q=%E8%8F%AF%E7%BE%A9',
        synthetic: false
    },
    {
        companyId: 'wayi',
        companyName: '華義國際',
        companyColor: '#9d4edf',
        title: '華義結盟香港及東南亞數位發行商，取得兩款日系動漫風格競技手遊台港澳代理權',
        category: '策略合作',
        huikeFolder: 'folder_3',
        huikeKeyword: '華義國際',
        excerpt: '香港01報導華義國際加速海外代理產品線儲備，簽約兩款在日本事前登錄突破 50 萬人的輕二次元競技對戰新作，預計年底展開台港澳封測。',
        date: '2026-08-21',
        source: '香港01',
        url: 'https://www.hk01.com/search?q=%E8%8F%AF%E7%BE%A9',
        synthetic: false
    },
    {
        companyId: 'wayi',
        companyName: '華義國際',
        companyColor: '#9d4edf',
        title: '華義國際上半年轉型綜效顯現獲利轉正，管理層宣示持續深耕泛娛樂跨平台遊戲生態',
        category: '財務報告',
        huikeFolder: 'folder_3',
        huikeKeyword: '華義國際',
        excerpt: '華義國際召開法人說明會，公告 2026 上半年受惠於社群廣告收入與海外 B2B 授權金入帳，本業獲利成功由虧轉盈，資產報酬率顯著回升。',
        date: '2026-08-31',
        source: '工商時報',
        url: 'https://www.ctee.com.tw/search/%E8%8F%AF%E7%BE%A9',
        synthetic: false
    },
    {
        companyId: 'wayi',
        companyName: '華義國際',
        companyColor: '#9d4edf',
        title: '華義國際探索 Web3 與合規數位資產流通機制，結合電競賽事獎勵開拓次世代玩家社群',
        category: '技術創新',
        huikeFolder: 'folder_3',
        huikeKeyword: '華義國際',
        excerpt: '華義國際研發團隊發表關於電競賽事社群虛擬積分跨平台流通之技術概念，強調所有架構將遵循台灣金管會洗錢防制法規與實名制驗證。',
        date: '2026-09-11',
        source: '科技新報',
        url: 'https://technews.tw/?s=%E8%8F%AF%E7%BE%A9',
        synthetic: false
    },
    ...
    },
    {
        ...
        companyName: '傳奇網路',
        companyColor: '#ff70a6',
        title: '傳奇長青 PC 端遊《精靈樂章：ORIGIN》全球服熱度不墜，穩定貢獻海外長期經常性收益',
        category: '財務報告',
        huikeFolder: 'folder_3',
        huikeKeyword: '傳奇網路',
        excerpt: '傳奇旗下經典 PC 線上遊戲《精靈樂章：ORIGIN》全球伺服器上線滿週年，藉由懷舊原汁原味玩法與定期賽季改版，成為集團最穩固的高毛利現金流金牛。',
        date: '2026-07-20',
        source: '自由時報',
        url: 'https://news.ltn.com.tw/search?keyword=%E5%82%B3%E5%A5%87%E7%B6%B2%E8%B7%AF',
        synthetic: false
    },
    {
        companyId: 'xlegend',
        companyName: '傳奇網路',
        companyColor: '#ff70a6',
        title: '傳奇網路公布 8 月合併營收創今年單月新高，「高毛利端遊 + 輕量手遊」雙軌佈局發威',
        category: '財務報告',
        huikeFolder: 'folder_3',
        huikeKeyword: '傳奇網路',
        excerpt: '傳奇網路 8 月合併營收達 1.62 億元，月增 15%、年增 28%，受惠於海外多語系發行效益持續發酵，自研遊戲全球累計玩家數再創里程碑。',
        date: '2026-08-12',
        source: '經濟日報',
        url: 'https://money.udn.com/search/result/1001/%E5%82%B3%E5%A5%87%E7%B6%B2%E8%B7%AF',
        synthetic: false
    },
    {
        companyId: 'xlegend',
        companyName: '傳奇網路',
        companyColor: '#ff70a6',
        title: '傳奇網路預告全新自研二次元冒險 RPG 於第四季展開全球封測，導入 AI 輔助多語言本地化',
        category: '新品發布',
        huikeFolder: 'folder_3',
        huikeKeyword: '傳奇網路',
        excerpt: '延續《風之國度》優異的美術底蘊，傳奇網路首度揭露開發代號為 Project A 的全新幻想冒險 MMORPG，主打手繪清新童話風與輕社交戰鬥。',
        date: '2026-08-27',
        source: '巴哈姆特',
        url: 'https://gnn.gamer.com.tw/search.php?kw=%E5%82%B3%E5%A5%87%E7%B6%B2%E8%B7%AF',
        synthetic: false
    },
    {
        companyId: 'xlegend',
        companyName: '傳奇網路',
        companyColor: '#ff70a6',
        title: '傳奇網路研發中心全面導入生成式 AI 輔助美術設計管線，大幅縮短 30% 遊戲版本迭代週期',
        category: '技術創新',
        huikeFolder: 'folder_3',
        huikeKeyword: '傳奇網路',
        excerpt: '為提升跨國版本營運效率，傳奇網路自行建置內部專屬動漫風格生成式 AI 模型庫，負責遊戲 UI 圖素生成與場景貼圖預覽，大幅釋放核心研發量能。',
        date: '2026-09-07',
        source: '數位時代',
        url: 'https://www.bnext.com.tw/search?q=%E5%82%B3%E5%A5%87%E7%B6%B2%E8%B7%AF',
        synthetic: false
    },
    {
        companyId: 'xlegend',
        companyName: '傳奇網路',
        companyColor: '#ff70a6',
        title: '傳奇網路維持高配息政策獲外資法人連續買超，自研 IP 全球版權營運維持極高資本回報率',
        category: '財務報告',
        huikeFolder: 'folder_3',
        huikeKeyword: '傳奇網路',
        excerpt: '傳奇網路財務結構優異無長期借款，且歷年均將獲利全數轉化為高額現金股利回饋股東，穩定的殖利率與全球版稅收入獲得機構投資人肯定。',
        date: '2026-09-12',
        source: '鉅亨網',
    ...
    },
    {
        ...
        companyName: '泰偉電子',
        companyColor: '#2a9d8f',
        title: '泰偉電子「叫號叫我」多媒體推播系統打入全台連鎖藥局與健檢機構，開拓智慧健康照護新藍海',
        category: '產業趨勢',
        huikeFolder: 'folder_3',
        huikeKeyword: '泰偉電子',
        excerpt: '泰偉跨足智慧醫療與多媒體推播有成，將其博弈娛樂機台硬體顯示技術移植至醫療叫號看板，畫面流暢穩定並支援雲端排隊提醒，受到院方高度肯定。',
        date: '2026-07-14',
        source: '科技新報',
        url: 'https://technews.tw/?s=%E6%B3%B0%E5%81%89',
        synthetic: false
    },
    {
        companyId: 'astro',
        companyName: '泰偉電子',
        companyColor: '#2a9d8f',
        title: '泰偉電子拓展東南亞離岸娛樂機台主機板軟硬整合外銷，取得多國海外合格供應商認證',
        category: '策略合作',
        huikeFolder: 'folder_3',
        huikeKeyword: '泰偉電子',
        excerpt: '泰偉電子宣布接獲菲律賓與柬埔寨大型娛樂綜合體商用遊戲機主機板新訂單，藉由穩定的嵌入式系統架構，海外硬體出貨量較去年同期回升逾 35%。',
        date: '2026-08-09',
        source: '工商時報',
        url: 'https://www.ctee.com.tw/search/%E6%B3%B0%E5%81%89%E9%9B%BB%E5%AD%90',
        synthetic: false
    },
    {
        companyId: 'astro',
        companyName: '泰偉電子',
        companyColor: '#2a9d8f',
        title: '泰偉電子 2026 前八月合併營收穩步回溫，公司表示將聚焦高毛利智慧管理軟體解決方案',
        category: '財務報告',
        huikeFolder: 'folder_3',
        huikeKeyword: '泰偉電子',
        excerpt: '泰偉電子公告 8 月營收報喜，隨著醫療智慧叫號 SaaS 雲端訂閱費用逐月遞增，非博弈軟體服務營收佔比已達整體三成，毛利率體質大幅翻揚。',
        date: '2026-09-02',
        source: '經濟日報',
    ...
    },
    {
        ...
        companyName: '泰偉電子',
        companyColor: '#2a9d8f',
        title: '泰偉電子結合物聯網 (IoT) 智慧感測技術升級雲端叫號機房，提供醫療院所即時人流監控調度',
        category: '技術創新',
        huikeFolder: 'folder_3',
        huikeKeyword: '泰偉電子',
        excerpt: '因應醫院門診壅塞痛點，泰偉研發出新一代 AI 候診時間預估演算法，透過手機 Line 官方帳號即可遠端抽號與震動提醒，有效緩解門診等候區人潮。',
        date: '2026-09-09',
        source: '數位時代',
        url: 'https://www.bnext.com.tw/search?q=%E6%B3%B0%E5%81%89',
        synthetic: false
    },
