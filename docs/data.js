...
// 每個公司的新聞範本 (包含新增之財經科技媒體專題報導)
const NEWS_TEMPLATES = {
    'soft-world': [
        { t: "智冠科技宣布二代接班，創辦人王俊博交棒王思淳接任董事長", c: "人事異動", e: "智冠科技今日召開董事會，正式通過由長女王思淳接任董事長一職，創辦人王俊博轉任集團總裁，象徵集團邁入二代接班全新階段。", s: "經濟日報" },
        { t: "智冠結盟榮剛換股案正式生效，成功鞏固集團經營權", c: "策略合作", e: "智冠與榮剛材料的股份交換案獲主管機關准予申報生效，雙方深化數位娛樂與實體材料跨界合作，為營運奠定穩固基石。", s: "鉅亨網" },
        { t: "MyCard 點數平台全面導入生成式 AI 智能客服系統", c: "技術創新", e: "為提升數百萬玩家體驗，智冠旗下 MyCard 點數平台導入次世代 AI 客服，平均問題處理時間縮短 60%，滿意度顯著提升。", s: "數位時代" },
        { t: "中華網龍《金庸群俠傳Online》經典 25 週年慶典開跑", c: "社群活動", e: "經典武俠網遊《金庸群俠傳Online》迎接 25 週年，官方宣布舉辦全台玩家線上線下巡迴週年慶，重溫經典江湖回憶。", s: "巴哈姆特" },
        { t: "藍新金流 2025 年交易額破千億大關，創歷史新高", c: "財務報告", e: "受惠於線上支付與電商普及，智冠旗下藍新金流 2025 全年交易額打破 1,200 億元大關，獲利表現亮眼。", s: "經濟日報" },
        { t: "智冠集團擴大東南亞支付佈局，首站結盟泰國在地業者", c: "策略合作", e: "智冠集團今日宣布與泰國領先的金流服務商達成戰略合作，正式將 MyCard 與跨境支付生態系延伸至東南亞市場。", s: "天下雜誌" }
    ],
    'softstar': [
        { t: "大宇資訊震撼彈！股東會通過更名「光聚晶電聯合」轉型控股", c: "產業趨勢", e: "大宇資訊今日召開股東臨時會，正式通過更名案，轉型為半導體、重電與綠能事業控股集團，遊戲業務移至子公司獨立營運。", s: "經濟日報" },
        { t: "處分《仙劍奇俠傳》《軒轅劍》雙劍 IP 完成交割，5億資金挹注", c: "財務報告", e: "大宇資訊公告已完成雙劍經典 IP 的全球處分程序，認列約 5 億元處分利益，大幅提升公司現金流與轉型資本。", s: "鉅亨網" },
        { t: "國產驚悚改編大作《咒》登陸 Steam 平台，全球熱銷十萬套", c: "新品發布", e: "改編自國片票房冠軍《咒》的同名恐怖遊戲正發售，全球玩家與遊戲 Streamer 評分極佳，首週即傳出銷量捷報。", s: "4Gamers" },
        { t: "光聚晶電（原大宇資）宣布併購知名 AI 散熱模組廠", c: "策略合作", e: "跨足高科技供應鏈，光聚晶電宣布收購國內 AI 伺服器散熱模組大廠，非遊戲事業營收佔比首度過半。", s: "數位時代" },
        { t: "《女鬼橋二 釋魂恩》奪得國際獨立遊戲大獎 Best Narrative", c: "產業趨勢", e: "大宇資自研恐怖遊戲續作《女鬼橋二》憑藉優異的台味恐怖敘事與 3D 視覺效果，榮獲國際獨立遊戲節最佳敘事獎。", s: "天下雜誌" }
    ],
    'gamania': [
        { t: "橘子集團宣告 2026 為「AI 商轉元年」，推邊緣算力與 Vyin AI", c: "技術創新", e: "橘子集團於媒體發布會上宣布全面轉型，導入 Vyin AI 與企業級邊緣算力解決方案，賦能旗下遊戲、支付與電商事業。", s: "數位時代" },
        { t: "跨平台 MMORPG 大作《波拉西亞戰記》台港澳盛大開服", c: "新品發布", e: "橘子代理發行的旗艦級攻城 MMORPG《波拉西亞戰記》正式上線，首日湧入百萬玩家，伺服器全線爆滿登頂排行榜。", s: "巴哈姆特" },
        { t: "《新楓之谷》歡慶 20 週年，於臺北流行音樂中心舉辦狂歡嘉年華", c: "社群活動", e: "台灣國民級網遊《新楓之谷》迎接 20 歲生日，官方於北流包場舉辦大型玩家線下見面會，吸引數萬玩家同樂。", s: "ETtoday" },
        { t: "《天堂M》重大職業改版登場，帶動橘子單月營收年增 18%", c: "財務報告", e: "受惠於長青手遊《天堂M》改版與年終慶典，橘子集團公布單月合併營收達 12.8 億元，創近二年同期新高。", s: "經濟日報" },
        { t: "橘子支付與有閑購物結合 AI 試穿，打造智慧零售生態圈", c: "技術創新", e: "橘子結合集團資安與 AI 技術，推出個人化智慧理財與購物虛擬試穿功能，有效降低退貨率並提高顧客黏著度。", s: "鉅亨網" }
    ],
    'wanin': [
        { t: "網銀國際斥資 12.49 億收購威秀影城 35.69% 股權，成最大股東", c: "策略合作", e: "網銀國際今日宣布完成全台最大連鎖影城威秀影城的股權交割，將實體影城通路與線上遊戲生態圈進行深度泛娛樂整合。", s: "經濟日報" },
        { t: "《星城Online》品牌煥新，啟用全新 Logo 正式更名為《星城》", c: "產業趨勢", e: "營運超過 18 年的休閒娛樂龍頭《星城Online》宣佈升級為全球跨平台品牌《星城》，展開跨生活場景的泛娛樂行銷。", s: "天下雜誌" },
        { t: "閃電狼 Flash Wolves 勇奪國際電競大賽季軍，再次登上世界舞台", c: "電競賽事", e: "網銀國際旗下職業電競隊伍閃電狼於世界大賽中力戰各國強權，最終奪得季軍，展現台灣電競實力。", s: "4Gamers" },
        { t: "網銀國際成立影視投資部門，結盟威秀影城每年投資 3-5 部國片", c: "策略合作", e: "發揮娛樂綜效，網銀國際宣布每年將投入數億元資金投資國產電影與影視 IP，打造虛實整合娛樂鏈。", s: "數位時代" }
    ],
    'wayi': [
        { t: "華義國際合資成立「華智」，正式宣佈進軍印度手遊市場", c: "策略合作", e: "看好印度龐大人口與手遊成長紅利，華義國際結盟在地業者成立合資公司「華智」，專攻休閒手遊開發生態。", s: "經濟日報" },
        { t: "華義子公司取得海外離岸 B2B 遊戲執照，擴大技術輸出", c: "產業趨勢", e: "華義國際旗下子公司成功考取國際認可之 B2B 娛樂技術服務商執照，未來將全力擴大海外軟體授權收益。", s: "鉅亨網" },
        { t: "「遊戲大亂鬥」社群論壇全面改版，導入創作者分潤機制", c: "技術創新", e: "華義旗下知名遊戲社群平台「遊戲大亂鬥」全新改版，新增影音創作者打賞與廣告分潤功能，大幅提升創作者意願。", s: "數位時代" }
    ],
    'userjoy': [
        { t: "宇峻奧汀 Q1 營收 5.19 億元創歷史新高，《FFXIV》繁中版熱銷", c: "財務報告", e: "受惠於代理營運 SQUARE ENIX 大作《FINAL FANTASY XIV》繁中版玩家爆滿及遊戲授權金，宇峻獲利寫下歷史新紀錄。", s: "經濟日報" },
        { t: "《三國群英傳：策定九州》雙平台盛大公測，迅速攻頂下載榜", c: "新品發布", e: "宇峻旗艦自研 IP 最新 SLG 手遊正式發行，以高品質水墨視覺與即時國戰玩法，獲得台港澳與東南亞玩家極高評價。", s: "巴哈姆特" },
        { t: "採用 UE5 引擎打造！宇峻首度公開次世代武俠 RPG 神祕新作", c: "技術創新", e: "宇峻奧汀於台北國際電玩展發表採用 Unreal Engine 5 開發的武俠 RPG 畫面，展現極致的光影與遊戲品質。", s: "數位時代" }
    ],
    'xlegend': [
        { t: "傳奇網路「高毛利 PC 端遊 + 輕量手遊」雙軌策略奏效，毛利率突破 60%", c: "財務報告", e: "傳奇網路公布最新財報，自研《精靈樂章：ORIGIN》與全球發行放置手遊《咻咻史萊姆》營收穩定，帶動毛利率創新高。" },
        { t: "《咻咻史萊姆》全球下載量突破千萬大關，成為海外休閒爆款", c: "新品發布", e: "傳奇自研的輕量放置手遊在歐美與日韓市場展現驚人爆發力，全球累積下載數破千萬，展現優異的研發能力。" }
    ],
    'astro': [
        { t: "泰偉電子完成減資 70% 改善財務體質，每股淨值回升", c: "財務報告", e: "泰偉電子公告完成減資彌補虧損流程，股票恢復正常交易，公司財務結構與營運資本獲得顯著改善。" },
        { t: "「叫號叫我」智慧醫療系統獲國內多間醫學中心採用", c: "產業趨勢", e: "泰偉電子跨足智慧醫療與多媒體推播有成，自研的「叫號叫我」醫療系統順利導入全台各大大型醫院。" }
    ]
};
...
function loadSources(companyId, month) {
    ...
    return PRESS_RELEASES.filter(news => {
        ...
        title: news.title,
        url: news.url || news.newsUrl || news.officialUrl || (COMPANIES.find(c => c.id === companyId)?.newsUrl || COMPANIES.find(c => c.id === companyId)?.website),
